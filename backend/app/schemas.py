...
class FeedbackCreate(BaseModel): user_id:str; correction:str; reason:str; scope:str; confidence:float=Field(.8,ge=0,le=1)
...
class EvalExample(BaseModel): query:str; relevant_chunk_ids:list[str]
