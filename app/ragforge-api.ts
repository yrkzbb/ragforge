...
export const ragforgeApi={
  ...
  chat:(message:string,userId="web-user",knowledgeBaseId=configuredKnowledgeBaseId)=>call<{answer:string;sources:Array<{chunk_id:string;breadcrumb:string;score:number}>;memory_ids:string[];handoffs:Array<{from:string;to:string}>;usage:Record<string,number>;trace_id:string}>("/api/v1/chat",{method:"POST",body:JSON.stringify({message,user_id:userId,knowledge_base_id:knowledgeBaseId})}),
